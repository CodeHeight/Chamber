    ...
    public partial class ConfigService : IConfigService
    {
        ...
        public OrderedDictionary GetEmoticonHashTable()
        {
            ...
            if (emoticons == null)
            {
                ...
                var emoticonNodes = root?.SelectNodes("/project/emoticons/emoticon");
        ...
        public Dictionary<string, string> GetProjectConfig()
        {
            ...
            if (siteConfig == null)
            {
                ...
                var root = SiteConfig.Instance.GetSiteConfig();
                var nodes = root?.SelectNodes("/project/settings/setting");
                if (nodes != null)
                {
        ...
        public Dictionary<string, string> GetTypes()
        {
            ...
            if (siteConfig == null)
            {
                siteConfig = new Dictionary<string, string>();
                var root = SiteConfig.Instance.GetSiteConfig();
                var nodes = root?.SelectNodes("/project/types/type");
                if (nodes != null)
                {
                    foreach (XmlNode node in nodes)
                    {
